...
urlpatterns = [
    ...
    path("subscribers/", cache_page(60)(SubscriberListView.as_view()), name="subscriber_list"),
    ...
    path("campaigns/", cache_page(60)(CampaignListView.as_view()), name="campaign_list"),
